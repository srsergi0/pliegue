...
export default function App() {
  ...
  const handleApplyTemplate = (tmpl: JobTemplate) => {
    ...
    setToastMsg(`✓ Plantilla aplicada: ${tmpl.title}`);
      ...
      <header className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-neutral-200/80 z-40 px-6 py-3.5 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-sm font-bold text-neutral-900 tracking-tight">Pliegue</h1>
            </div>
            <p className="text-[10px] text-neutral-400">Preprensa Digital & Imposición de Pliegos</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            title="Plantillas de taller de 1 clic (Folleto, Tarjetas, Flyers, Libro)"
          ...
          {pdfBytes && isDesktop && (
            <button
              ...
              title="Abrir otro documento PDF"
            >
      ...
      {savedFilePath && (
        ...
        >
          <div className="flex items-center gap-2.5 overflow-hidden">
            ...
            <span className="font-semibold">¡PDF guardado exitosamente!</span>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-6 max-w-4xl mx-auto w-full min-w-0">
            ...
            <div className="text-center mb-8 max-w-lg select-none">
              <h2 className="text-xl font-extrabold text-neutral-900 tracking-tight mb-2">
                Imposición de Páginas Profesional
              </h2>
            ...
            >
              {parsing ? (
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-neutral-700">Analizando documento PDF...</p>
                    <p className="text-[10px] text-neutral-400">Extrayendo páginas y calculando pliegos</p>
                  </div>
                </div>
              ) : (
                <div className="flex flex-col items-center gap-4 select-none">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-neutral-700">
                      {dragOver ? (
                        <span className="text-amber-700 font-bold text-sm">¡Suelta el archivo PDF aquí!</span>
                      ) : (
                        <>
                          Arrastra tu archivo PDF aquí o <span className="text-neutral-950 underline decoration-2">búscalo en tu PC</span>
                        </>
                      )}
                    </p>
                    <p className="text-[10px] text-neutral-400 mt-1">Soporta cualquier tamaño de página original</p>
                  </div>
