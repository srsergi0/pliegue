...
- 🧭 **集中できる面付けワークフロー**:
  - 折りたたみ可能な5ステップのリニアパネル（製品・用紙・面付け・印刷・仕上げ）。
  - 各ステップへジャンプできるジョブサマリーのチップと、生産集計・現在の用紙情報を示す下部ステータスバー。
  - 表裏を色分けした用紙ナビゲーションと、無効ページを表示／非表示できるパネル。
- 🌐 **多言語インターフェース**:
  - スペイン語・英語・日本語・簡体字中国語に対応。初回起動時はシステム言語を自動検出。
